...
const SYSTEM = [
  ...
  '  · holdDays.win 만 있고 loss 가 null 이면 이익 매도만 있었다는 뜻입니다.',
  '    "빠르게 팔았다", "손실 확대를 막았다" 처럼 평가하지 마세요 — 비교 대상도, 막은 손실도 없습니다.',
  '    이때는 보유기간·처분효과를 총평에서도 다루지 마세요.',
  '  · 손실 매도가 없으면 "손실을 막았다"고 쓰지 마세요. 손실이 날 일이 없었을 뿐입니다.',
  '  · 승률은 trades.sells 가 3건 이상일 때만 근거로 쓰세요.',
  '    그보다 적으면 "매도 N건으로 판단하기 이르다" 고만 쓰고 잘한 점에 넣지 마세요.',
